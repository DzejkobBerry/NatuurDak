            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              {activeTab === 'sedumtak' ? (
                ...
                <div>
                  ...
                  {/* CZWARTA SEKCJA - Groene binnenplaatsen - Intensieve beplanting */}
                  <div className="mt-16">
                    <div className="bg-gradient-to-r from-green-50 via-green-100 to-green-50 rounded-2xl p-8 shadow-lg border border-green-100/50 backdrop-blur-sm">
                      <div className="text-center mb-8">
                  ...
                  {/* SZÓSTA SEKCJA - Groene binnenplaatsen - Małe rośliny */}
                  <div className="mt-16">
                    <div className="bg-white rounded-2xl p-8 shadow-lg border border-green-100/50 backdrop-blur-sm">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                        <div className="flex items-start space-x-3">
                          <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                          <p className="text-secondary-700 text-sm font-medium">
                            Groene binnenplaatsen – Verharde oppervlakken, bereden rijvlakken, enz.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 p-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center space-x-2 p-2 bg-green-50 rounded hover:bg-green-100 transition-colors duration-200">
                              <div className="w-5 h-5 bg-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold">1</div>
                              <p className="text-secondary-700 text-sm font-medium">Verharding</p>
                            </div>
                            <div className="flex items-center space-x-2 p-2 bg-green-50 rounded hover:bg-green-100 transition-colors duration-200">
                              <div className="w-5 h-5 bg-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold">2</div>
                              <p className="text-secondary-700 text-sm font-medium">Draaglaag</p>
                            </div>
                            <div className="flex items-center space-x-2 p-2 bg-green-50 rounded hover:bg-green-100 transition-colors duration-200">
                              <div className="w-5 h-5 bg-green-600 text-white rounded-full flex items-center justify-center text-xs font-bold">3</div>
                        ...
                        <div className="flex items-center justify-center">
                          <div className="w-full max-w-xs">
                            <img 
                              src="https://i.imgur.com/cYRYA8O.png" 
                              alt="Opbouw van intensief groendak lagen diagram" 
                              className="w-full h-auto rounded-lg opacity-90 hover:scale-105 transition-transform duration-300 ease-out"
                            />
                          </div>
                ...
                /* Accessoires & Aanvullingen layout */
                <div className="text-center mb-12">
                  <div className="bg-gradient-to-r from-green-50 via-blue-50 to-green-50 rounded-2xl p-8 shadow-lg border border-green-100/50 backdrop-blur-sm">
                    <div className="flex items-center justify-center mb-6">
                      <div className="flex space-x-2">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-center space-x-3 mb-4">
                        ...
                        <h3 className="text-xl font-bold text-green-800">Ontworpen door Seduna</h3>
                      </div>
                      <p className="text-lg text-secondary-700 leading-relaxed max-w-4xl mx-auto font-medium">
                        De accessoires van Seduna voor groene daken zijn ontworpen door Seduna zelf. Met meer dan 30 jaar ervaring hebben we een serie accessoires ontwikkeld voor groene daken die zorgen voor een efficiënte afvoer en de vegetatie en opbouw beschermen tegen windopheffing. Onze accessoires zijn goedgekeurd volgens de industrienormen.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                        <div className="bg-white/70 rounded-lg p-4 border border-green-200/50 hover:shadow-md transition-all duration-300">
                          <div className="flex items-center space-x-2 mb-2">
                    ...
                    {/* Nowa sekcja tekstowa ze zdjęciami */}
                      ...
                      {/* Element 1 - Dakafvoersysteembescherming */}
                      <div className="bg-white rounded-2xl p-8 shadow-lg border border-green-100/50">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          <div className="order-2 lg:order-1">
                            <h3 className="text-2xl font-bold text-green-700 mb-4">Dakafvoersysteembescherming</h3>
                            <p className="text-lg text-secondary-700 leading-relaxed">
                              Dakafvoersysteembescherming houdt binnendakafvoeren op lage hellende daken vrij van vuil en vegetatieresten. Dakafvoeren zijn daardoor eenvoudig te vinden en te inspecteren.
                            </p>
                          </div>
                          <div className="order-1 lg:order-2">
                            <div className="bg-gradient-to-br from-green-200 to-blue-200 rounded-xl p-6 flex justify-center items-center h-64 border border-green-300">
                              <img 
                                src="https://i.imgur.com/vdrjdbq.png" 
                                alt="Dakafvoersysteembescherming" 
                                className="max-w-full max-h-full object-contain rounded-lg shadow-sm transition-transform duration-300 hover:scale-105"
                              />
                            </div>
                          </div>
                      ...
                      <div className="bg-white rounded-2xl p-8 shadow-lg border border-green-100/50">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          <div className="order-1 lg:order-1">
                            <div className="bg-gradient-to-br from-green-200 to-blue-200 rounded-xl p-6 flex justify-center items-center h-64 border border-green-300">
                              <img 
                                src="https://i.imgur.com/jv1rsBH.png" 
                                alt="SSG-goot 30" 
                                className="max-w-full max-h-full object-contain rounded-lg shadow-sm transition-transform duration-300 hover:scale-105"
                              />
                            </div>
                          ...
                          <div className="order-2 lg:order-2">
                            <h3 className="text-2xl font-bold text-green-700 mb-4">SSG-goot 30</h3>
                            <p className="text-lg text-secondary-700 leading-relaxed">
                              De SSG 30 is een open goot die wordt geïnstalleerd onder uitwerpers en regenpijpen om te voorkomen dat vegetatie en substraat van het dak worden geërodeerd of weggespoeld.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-2xl p-8 shadow-lg border border-green-100/50">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          <div className="order-2 lg:order-1">
                            <h3 className="text-2xl font-bold text-green-700 mb-4">STA-50 Grasversterking</h3>
                            <p className="text-lg text-secondary-700 leading-relaxed">
                              De Seduna STA 50 is een doorlatende en berijdbare grondversterking. De plaat wordt op een stabiele ondergrond gelegd en gevuld met stevig en goed gedraineerd grind of gras. De platen kunnen ook op groene daken worden gebruikt als looproutes naar service-ruimtes op het dak. De plaat is gemaakt van gerecycled HDPE-plastic en kan belastingen tot 300 ton/m² weerstaan.
                            </p>
                          </div>
                          <div className="order-1 lg:order-2">
                            <div className="bg-gradient-to-br from-green-200 to-blue-200 rounded-xl p-6 flex justify-center items-center h-64 border border-green-300">
                              <img 
                                src="https://i.imgur.com/8MRxa4A.png" 
                                alt="STA-50 Grasversterking" 
                                className="max-w-full max-h-full object-contain rounded-lg shadow-sm transition-transform duration-300 hover:scale-105"
                              />
                            </div>
                          </div>
