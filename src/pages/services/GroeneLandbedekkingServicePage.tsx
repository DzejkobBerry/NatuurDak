            ...
            {activeTab === 'vaste' && (
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                 ...
                 {/* Additional Vinca minor Atropurea section with swapped layout */}
                 <div className="mt-16">
                 ...
                 {/* Sixth Euonymus Fortunei section */}
                 <div className="mt-16">
                   <h3 className="text-2xl font-display font-bold text-green-600 text-center mb-8">Euonymus Fortunei</h3>
                   <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                     <div className="space-y-6">
                       <div className="bg-green-50 rounded-lg p-6">
                         <div className="overflow-x-auto">
                           <table className="w-full">
                             <tbody>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Handelsnaam</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Kardinaalsmuts Horts Blaze</td>
                               </tr>
                               <tr>
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Kleur / Bloei</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">–</td>
                               </tr>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Winterhardheid</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">B</td>
                               ...
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800">Hoogte</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800">20–45 cm</td>
                               </tr>
                             </tbody>
                           </table>
                         </div>
                     ...
                     <div className="flex justify-center items-center">
                       <img src="https://i.imgur.com/Dn1frZg.png" alt="Euonymus Fortunei" className="w-full max-w-md h-80 object-contain mt-16 rounded-lg" />
                     </div>
                   </div>
                 </div>
                 
                 {/* Seventh Nepeta Walker's Low section */}
                 <div className="mt-16">
                         ...
                         <div className="overflow-x-auto">
                           <table className="w-full">
                             <tbody>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Handelsnaam</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Kattenkruid</td>
                               </tr>
                               <tr>
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Kleur / Bloei</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Blauw, juni/september</td>
                               </tr>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Winterhardheid</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">C</td>
                               </tr>
                               <tr>
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Standplaats</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Zon</td>
                               </tr>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800">Hoogte</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800">30–50 cm</td>
                               </tr>
                             </tbody>
                           </table>
                         </div>
                         ...
                         <div className="overflow-x-auto">
                           <table className="w-full">
                             <tbody>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Handelsnaam</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Ooievaarsbek</td>
                               </tr>
                               <tr>
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Kleur / Bloei</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">Wit/roze, juni/juli</td>
                               </tr>
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800 border-b border-green-200">Winterhardheid</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800 border-b border-green-200">B</td>
                               ...
                               <tr className="bg-green-100">
                                 <td className="px-4 py-3 font-semibold text-green-800">Hoogte</td>
                                 <td className="px-4 py-3 text-right font-medium text-green-800">20–30 cm</td>
                               </tr>
                             </tbody>
                           </table>
                         </div>
